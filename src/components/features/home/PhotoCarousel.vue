...
<template>
    <section class="py-10 sm:py-16 md:py-20 bg-transparent from-gray-50 to-blue-50">
        <div class="container mx-auto px-4 sm:px-6 md:px-8">
            <div class="text-center mb-8 sm:mb-12 md:mb-16">
                <h1 class="text-3xl max-w-xs sm:max-w-5xl sm:text-5xl lg:text-5xl font-semibold leading-normal mb-6 mx-auto">
                    Looking Back at <span class="bg-gradient-to-r from-[#EE7A13] to-[#B47EDE] bg-clip-text text-transparent">Tekkom ’25</span>
                </h1>
                <p class="text-base sm:text-lg max-w-2xl mx-auto px-4">
                ...
                <template #default="{ item }">
                    <div class="relative group cursor-pointer overflow-hidden rounded-xl sm:rounded-2xl shadow-lg sm:shadow-2xl mx-2 sm:mx-0">
                        <LazyImage :src="item.image" :alt="item.title"
                            class="w-full h-[300px] sm:h-[400px] md:h-[450px] lg:h-[600px] object-cover transition-transform duration-700 group-hover:scale-110" />
                        ...
                        <div
                            ...
                            <div class="absolute bottom-0 left-0 right-0 p-4 sm:p-6 md:p-8">
                                ...
                                <p class="text-sm sm:text-base mb-1 sm:mb-2">{{ item.description }}</p>
