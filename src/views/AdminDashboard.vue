  ...
  <section class="min-h-screen bg-slate-950 text-white px-4 py-12">
    <div class="mx-auto flex max-w-6xl flex-col gap-6">
      ...
      <div v-else>
        ...
        <div v-if="loading" class="py-10 text-slate-200">Memuat data...</div>
        <div v-else-if="error" class="py-10 text-red-200">{{ error }}</div>
        <div v-else-if="!profiles.length" class="py-10 text-slate-200">Tidak ada data profil.</div>

        <div v-else class="overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg">
        ...
        <p v-if="success" class="mt-3 text-sm text-emerald-300">{{ success }}</p>
        <p v-if="error && !loading" class="mt-3 text-sm text-red-200">{{ error }}</p>
